...
public class BoardView {
	...
	public void selectBoard() {
		...
		// -> 조회 수 증가 (단, 자신이 작성한 게시글일 경우 조회수 증가 X)
		// -> 자신이 작성한 게시글일 경우
		//	  수정 / 삭제 기능 노출
		// + 댓글 목록 / 댓글 기능 추가 예정
		...
		try {
			...
			/* 해당 게시글의 댓글 목록 조회 */
			if(!board.getCommentList().isEmpty()) { // 게시글에 댓글이 있다면
			...
			commentView.commentMenu(input); // input : 현재 게시글 번호
